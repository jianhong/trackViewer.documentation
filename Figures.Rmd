...
iPSC_dC_T.BSseq <- import("IPSC_dC-T.BS.bedGraph", which = gr, format = "bedGraph")
iPSC_dC_dT.BSseq <- import("IPSC_dC-dT.BS.bedGraph", which = gr, format = "bedGraph")
## prepare for pie type
iPSC_dC_T.BSseq$score2 <- 100 - iPSC_dC_T.BSseq$score
iPSC_dC_T.BSseq$color <- list(c("black", "white"))
iPSC_dC_dT.BSseq$color <- list(c("black", "white"))
iPSC_dC_T.BSseq$type <- "pie"
iPSC_dC_dT.BSseq$type <- "pie"
iPSC_dC_T.BSseq <- new("track", dat=iPSC_dC_T.BSseq, type="lollipopData")
iPSC_dC_dT.BSseq <- new("track", dat=iPSC_dC_dT.BSseq, type="lollipopData")
## optimize stlye
...
## adjust track stlyes
setTrackStyleParam(trackList[["iPSC_dC_T.BSseq"]], "color", "orange")

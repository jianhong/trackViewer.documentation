...
## adjust track stlyes
setTrackStyleParam(trackList[["iPSC_mock.RNAseq"]], "color", "orange")
setTrackStyleParam(trackList[["iPSC_mock.RNAseq"]], "ylabgp", 
                   list(cex=trackList[["iPSC_mock.RNAseq"]]$style@ylabgp$cex,
                        col="orange"))
